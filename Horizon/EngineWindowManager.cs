...
public class EngineWindowManager : Entity
{
    ...
    private void UpdateViewport()
    {
        ...
        ViewportSize =
            (Engine.Debugger.Enabled && Engine.Debugger.GameContainerDebugger.Visible)
                ? new Vector2(
                    Engine.Debugger.GameContainerDebugger.FrameBuffer.Width,
                    Engine.Debugger.GameContainerDebugger.FrameBuffer.Height
                )
