...
<tileset version="1.10" tiledversion="1.10.2" name="tileset" tilewidth="16" tileheight="16" tilecount="220" columns="11">
 <image source="Forest Tilesett.png" width="176" height="320"/>
 <wangsets>
  <wangset name="path_0" type="corner" tile="-1">
  ...
  <wangset name="path_1" type="corner" tile="-1">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   ...
   <wangtile tileid="72" wangid="0,1,0,1,0,0,0,1"/>
   <wangtile tileid="77" wangid="0,1,0,0,0,0,0,0"/>
   <wangtile tileid="78" wangid="0,1,0,0,0,0,0,1"/>
